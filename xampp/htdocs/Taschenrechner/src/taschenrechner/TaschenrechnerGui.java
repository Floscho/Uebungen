...
public class TaschenrechnerGui extends javax.swing.JFrame {
    ...
    private void btnDzActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDzActionPerformed
        System.out.println(evt.getActionCommand());
        if (evt.getActionCommand().equals("-") && lblDis.getText().equals("0"))
            lblDis.setText("-");
    }//GEN-LAST:event_btnDzActionPerformed

    private void btnEqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEqActionPerformed
        System.out.println(evt.getActionCommand());    }//GEN-LAST:event_btnEqActionPerformed
